...
def job():
    ...
    files = {file for file in os.listdir(os.path.join(Store_path, 'Bitstreams'))}
    failed_TCs = {file for file in os.listdir(os.path.join(DLOC_path, 'iter1')) if file.startswith('TC') if
