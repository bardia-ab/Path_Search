...
def gen_CR_TC_sources(CR, DLOC_path, TC_file, opts, vivado_src_path, N_Parallel, name_prefix):
    ...
    VHDL_file = create_VHDL_templlate()
    ...
    if opts == '-e':
        ...
        TC_idx = TC_idx + '_even'
        vivado_src_path = os.path.join(vivado_src_path, 'Split_Sources')
    elif opts == '-o':
...
Data_path = '/home/bardia/Desktop/bardia/Timing_Characterization/Data_local'
DLOC_path = '/home/bardia/Desktop/bardia/Timing_Characterization/Data_local/splited_TCs'
store_path = '/home/bardia/Desktop/bardia/Timing_Characterization/Data_local/Vivado_Sources_local'
result_path = '/home/bardia/Desktop/bardia/Timing_Characterization/Data_local/Results'
bitstreams_path = os.path.join(Data_path, 'Bitstreams')
logs_path = os.path.join(Data_path, 'Logs')
###########
